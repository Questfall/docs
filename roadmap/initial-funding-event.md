...
Founders will receive Silver as soon as they log in to Questfall, meaning that the Silver bonus is not tied to the NFT itself, but rather to the wallet address used by the Founder during the IFE. And while Silver is non-tradable and non-withdrawable, it will be fully released immediately after the first sign-in, giving Founders an early boost in the system.
