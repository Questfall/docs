...
| Reset character attribute points | Live where the reset surface is available |
| Participate in future Gold withdrawal auctions | Planned |

## Gold And RPG Items

In the current RPG item loop, Gold is connected to clothing:

* players can use Gold to open Common Lootboxes;
* lootboxes create clothing;
* clothing can be sold on the marketplace;
* marketplace fees burn part of the sale value;
* players can convert Gold into Silver for progression needs.

Future systems may connect Gold to higher-rarity production, Gem-based rarity evolution, and QFT withdrawal flows. Those should be treated as planned economy surfaces until they are live.
