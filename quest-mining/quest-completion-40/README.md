...
Mining Power can be increased by investing the attribute points gained with each new level into the Mining [attribute](attributes-1.md) or by equipping [clothing](items.md) with the appropriate effects.
