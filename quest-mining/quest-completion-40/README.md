...
Mining Power can be increased by investing the attribute points gained with each new level into the [Mining](rpg-attributes/mining.md) attribute or by equipping [clothing](items.md) with the appropriate effects.
