...
{% hint style="info" %}
For more details read about the rewarding for the [User activity](mining/user-activity-40/).
{% endhint %}
...
{% hint style="info" %}
For more details read about the rewarding for the [Author activity](mining/author-activity-30/).
{% endhint %}
