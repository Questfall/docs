...
{% hint style="info" %}
For more details read about the rewarding for the [User activity](qft-distribution/user-rewards-40/).
{% endhint %}
...
{% hint style="info" %}
For more details read about the rewarding for the [Author activity](qft-distribution/author-rewards-20/).
{% endhint %}
